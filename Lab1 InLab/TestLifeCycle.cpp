...
#include "LifeCycle.h"
// prototype goes to the top of the first file it compile, so that it would tell the compiler there must be these functions  from body.
